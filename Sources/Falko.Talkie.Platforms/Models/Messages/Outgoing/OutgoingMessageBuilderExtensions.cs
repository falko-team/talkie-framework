...
{
    public static IOutgoingMessageBuilder AddContent
    (
        this IOutgoingMessageBuilder builder,
    ...
    public static IOutgoingMessageBuilder SetContent
    (
        this IOutgoingMessageBuilder builder,
    ...
    public static IOutgoingMessageBuilder SetReply
    (
        this IOutgoingMessageBuilder builder,
