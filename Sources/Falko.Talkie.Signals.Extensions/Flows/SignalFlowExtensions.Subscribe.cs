...
{
    public static Subscription Subscribe(this ISignalFlow flow, IReadOnlySignalHandlingPipelineBuilder builder)
    {
    ...
    public static Subscription Subscribe<T>(this ISignalFlow flow, Func<ISignalInterceptingPipelineBuilder<T>,
        IReadOnlySignalHandlingPipelineBuilder> builderFactory) where T : Signal
    {
