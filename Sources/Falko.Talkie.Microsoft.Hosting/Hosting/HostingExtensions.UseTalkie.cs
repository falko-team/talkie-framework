...
public static partial class HostingExtensions
{
    ...
    private static IServiceCollection TryAddShutdown(this IServiceCollection services,
        TalkieHostingConfiguration configuration)
    {
        if (configuration.ShutdownOnUnobservedExceptions)
        {
            return services.AddBehaviors<UnobservedExceptionsShutdownSubscriber>();
        }

        return services.AddBehaviors<UnobservedExceptionsLoggingSubscriber>();
    }

    private static IServiceCollection TryAddSignalsLogging(this IServiceCollection services,
        TalkieHostingConfiguration configuration)
    {
